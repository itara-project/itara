 ...
 *
 * <p>Loads jars from the directory specified by -Ditara.lib.dir.
 * Uses child-first delegation so Itara runtime jars can use
 * different dependency versions than the application.
 *
 * <p>Classes from itara-core (ItaraTransport, ItaraActivator,
 ...
 *
 * <p>If -Ditara.lib.dir is not set or the directory is empty,
...
public class ItaraClassLoader extends URLClassLoader {
     ...
     *
     * <p>Returns the parent classloader unchanged if the property
     * is not set or the directory contains no jars.
     *
     * @param parent the classloader to delegate to and fall back on
     * @return a new {@link ItaraClassLoader} wrapping {@code parent}, or
     *         {@code parent} itself unchanged if there is nothing to load
     */
     ...
     *
     * <p>Try our jars first, fall back to parent for anything we don't have.
     ...
     * @throws ClassNotFoundException if neither this classloader's jars
     *         nor the parent can find the class
     */
    @Override
