 ...
 *
 * <p>`.itara` files are named without a version (design decision in the
 ...
 *
 * <p>Jars on the other hand carry a version in their filename
 * (e.g. "inventory-component-0.1.0.jar"). Callers resolving a
 ...
 *
 * <p>The index is a singleton: it must be built exactly once via
 ...
 *
 * <p>A missing/unreadable directory or an unparsable `.itara` file is a
...
public class ItaraMetadataIndex {
     ...
     *   inventory-component-0.1.0  ->  inventory-component
     *   gateway-0.1.0                     ->  gateway
     *   pricing-service-2.3.1-rc1         ->  pricing-service
     *
     * <p>A version segment is taken to start at the first '-' followed by a
     ...
     *
     * <p>Used by the agent to find the [implemented-event-contracts]
     ...
     *
     * <p>Used by the agent to find the [methods] declarations for a contract
