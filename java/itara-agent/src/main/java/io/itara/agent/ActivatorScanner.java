 ...
 *
 * Singleton, scanned exactly once per JVM via {@link #scan}, during agent
 ...
 *
 * Isolated vs. shared mode is strictly opt-in: isolated mode is used if
 ...
 *
 * In isolated mode, each local component's classloader is resolved by
 ...
 *
 * Component identity (id, version, api-version) is not read from this
