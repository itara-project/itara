 ...
 *
 * Produced by {@link ItaraSerializerFactory#parseConfig} from the raw
 ...
 * not passed further.
 *
 * The registry calls {@link #groupingKey()} to decide whether an existing
 ...
 *
 * Implementations should be immutable. Records are the natural choice.
 */
public interface ItaraSerializerConfig {
     ...
     *
     * Two configs with equal grouping keys share one serializer instance.
