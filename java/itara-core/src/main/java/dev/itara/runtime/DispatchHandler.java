 ...
 *
 * <p>The transport calls dispatch() with raw request bytes and writes the
 ...
 *
 * <p>The implementation — owned by the agent — handles the full inbound pipeline:
 * observability, authentication, authorization, deserialization, component
 * invocation, result serialization.
 *
 * <p>A DispatchHandler is constructed once per inbound connection at startup,
 ...
 *
 * <p>getDispatchKey() identifies which declared connection this handler serves.
