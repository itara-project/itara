 ...
 *
 * <p>The factory — not {@link ItaraTransport} itself — is what the agent
 * discovers at startup, via META-INF/itara/transport on the classpath,
 * and uses to parse connection configs and create transport instances
 * on demand.
 *
 * <p>The factory is called twice per connection that needs a new transport
