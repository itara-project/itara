 ...
 *        -Dtopos.config=wiring-direct.yaml
 *        -cp topos-common.jar;calculator-api.jar;calculator-component.jar;gateway-api.jar;gateway-component.jar
...
public class DemoMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("Topos Demo starting...");
        System.out.println("=".repeat(50));
